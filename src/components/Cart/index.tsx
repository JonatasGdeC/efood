                ...
                <S.Form>
                  ...
                  <S.Input>
                    ...
                    <input
                      ...
                      className={
                        checkInputIsError('receiptName') ? 'inputIsError' : ''
                      }
                    />
                  </S.Input>
                  <S.Input>
                  ...
                  <S.InputGroup>
                    <S.Input>
                      ...
                      <input
                        ...
                        onBlur={form.handleBlur}
                        className={
                          checkInputIsError('addressCode') ? 'inputIsError' : ''
                        }
                      />
                    </S.Input>
                    <S.Input>
                ...
                <S.Form>
                  ...
                  <S.Input>
                    ...
                    <input
                      ...
                      onBlur={form.handleBlur}
                      className={
                        checkInputIsError('cardName') ? 'inputIsError' : ''
                      }
                    />
                  </S.Input>
                  <S.InputGroup>
                    <S.Input>
                      ...
                      <input
                        ...
                        onBlur={form.handleBlur}
                        className={
                          checkInputIsError('cardNumber') ? 'inputIsError' : ''
                        }
                      />
                    </S.Input>
                    <S.Input>
                      ...
                      <input
                        ...
                        onBlur={form.handleBlur}
                        className={
                          checkInputIsError('cardCode') ? 'inputIsError' : ''
                        }
                      />
                    </S.Input>
                  </S.InputGroup>
                  <S.InputGroup>
                    <S.Input>
                      ...
                      <input
                        ...
                        onBlur={form.handleBlur}
                        className={
                          checkInputIsError('expireMonth') ? 'inputIsError' : ''
                        }
                      />
                    </S.Input>
                    <S.Input>
                      ...
                      <input
                        ...
                        onBlur={form.handleBlur}
                        className={
                          checkInputIsError('expireYear') ? 'inputIsError' : ''
                        }
                      />
                    </S.Input>
                  </S.InputGroup>
